...
class FaceNet(nn.Module):
    ...
    def forward(self, x):
        ...
        ##print('MaxPoolNorm:', x.size())
        
        x = self.inception2_1(x)
        #print('Inception2.1:', x.size())
        x = self.inception2_2(x)
        #print('Inception2.2:', x.size())
        ...
        #print('Inception3a:', x.size())
        x = self.inception3b(x)
        #print('Inception3b:', x.size())
        x = self.max_pool(self.inception3c(x))
        #print('Inception3c + MaxPool:', x.size())
        
        x = self.inception4a(x)
        #print('Inception4a:', x.size())
        x = self.inception4b(x)
        #print('Inception4b:', x.size())
        x = self.inception4c(x)
        #print('Inception4c:', x.size())
        x = self.inception4d(x)
        #print('Inception4d:', x.size())
        x = self.max_pool(self.inception4e(x))
        #print('Inception4e + MaxPool:', x.size())
        
        x = self.inception5a(x)
        #print('Inception5a:', x.size())
        x = self.inception5b(x)
        #print('Inception5b:', x.size())
